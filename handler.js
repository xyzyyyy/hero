...
module.exports = {
        ...
        try {
            ...
            try {
                ...
                if (settings) {
                    ...
                    if (!'antidelete' in settings) settings.antidelete = false
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                       // this.sendButton(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy*`, wm, 0, [['Buy', '.buy1']], m)
                         this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy* atau .buyall untuk membeli semua limit`, m)
    ...
    async groupsUpdate(update) {
        ...
        for (let groupUpdate of update) {
            ...
            if (!text) continue
            this.sendHydrated(id, "\n               *「 DETECTION 」*\n\n" + text, set.wm, set.fla + 'detection', 0, 0, 'https://www.whatsapp.com/otp/copy/bit.ly/bit.ly/Ac', 'Tutorial Prank Orang', [[]], null, { asLocation: true, mentions: member })
        }
    },
