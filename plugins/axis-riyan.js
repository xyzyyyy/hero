...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	async function cekkuota() {  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      let quota = await axios({
        ...
        headers: {
          ...
          "Authorization": `e8329def-adc9-4e6e-bce6-6ede35cd3a26`, //ambil di https://tools.tutorialinjectid.my.id/auth-axis/index.php
