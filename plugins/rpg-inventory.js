let handler = async (m, { conn, usedPrefix }) => {
    ...
    let mangga = member.mangga
    let bibitmangga = member.bibitmangga
    let anggur = member.anggur
    let bibitanggur = member.bibitanggur
    let pisang = member.pisang
    let bibitpisang = member.bibitpisang
    let jeruk = member.jeruk
    let bibitjeruk = member.bibitjeruk
    let apel = member.apel
    let bibitapel = member.bibitapel
