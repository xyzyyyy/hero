...
const xp_first_time = 25000
const xp_link_creator = 70000
const xp_bonus = {
    5: 40000,
   10: 100000,
   20: 250000,
...
`.trim(), link_creator)
    ...
    let code = users[m.sender].ref_code = users[m.sender].ref_code || new Array(11).fill().map(() => [...'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'][crypto.randomInt(62)]).join('')
